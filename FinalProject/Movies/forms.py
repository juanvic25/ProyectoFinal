...
class MovieForm(forms.Form):
    ...
    Fecha_Estreno= forms.DateField(widget=forms.DateInput(attrs={'type': 'date'}), label="Fecha de Estreno", required=False)
    Categoria   = forms.ModelChoiceField(queryset=category.objects.filter(active=True))
